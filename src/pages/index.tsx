...
function HomePage() {
  return (
    <>
      <Head>
        <title>radical-football57</title>

        <meta
          name="description"
          content="Empower Your Players with Radical-Football57: The Ultimate Youth Soccer Academy Management Platform for Personalized Coaching and Accelerated Development."
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              Empower Your Players with Radical-Football57: The Ultimate Youth Soccer Academy Management Platform for
